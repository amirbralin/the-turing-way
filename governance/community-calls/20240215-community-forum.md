...
* It might be interesting to adopt a metadata standard for embedding alt text into the image metadata as well as including it in the text of the book see: [https://www.iptc.org/standards/photo-metadata/iptc-standard/](https://www.iptc.org/standards/photo-metadata/iptc-standard/) where they have an alt text field, that way alt text can 'follow the image around' if it is copied to other places. I don't know if support for this exists in any screen reading software yet.
